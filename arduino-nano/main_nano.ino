...
// Configured for standard 16 MHz Uno/Nano crystal
...
void setup() {
  // Disable Timer0 interrupt to maximize bus polling timing
  TIMSK0 = 0;
  init_bus_asm();
...
void loop() {
  // Unused: main logic executes inside run_disk_controller() loop
}